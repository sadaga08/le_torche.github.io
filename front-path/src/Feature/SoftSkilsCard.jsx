...
const SoftSkilsCard = ({ article, index }) => {
  const imageUrl = article.image
   ...
   return (
     <div className="w-full py-6 px-4">
       <div className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition duration-300 p-6 group">
         ...
         <div className="flex items-center justify-center text-center mb-4">
           <h1 className="text-2xl text-slate-950 font-bold group-hover:text-cyan-600 transition duration-300">
             {article.titre}            {/* ✅ titre au lieu de title */}
           </h1>
         </div>
